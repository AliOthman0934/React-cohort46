...
function ProductDetail() {
    ...
    return (
        <div>
            ...
            {!loading && product && (
                <div className='card mb-3' style={{  textAlign: "center", margin: "auto" }}>
                    <div className="icon-custom-pro" onClick={handleFavoriteToggle}>
                        {isFavorite ? (
                    ...
                    <img className='card-img-top' src={product.image} alt={product.title} style={{width:140, margin:"auto"}} />
